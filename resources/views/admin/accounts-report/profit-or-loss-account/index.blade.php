@extends('layouts.app')
@section('title')
    {{ __('root.reports.profit_or_loss_account_manage') }}
@stop
@section('top-bar')
...
@section('content')
    <section @if($is_rtl) dir="rtl" @endif class="content">
        <div class="header">
            <h2 class="text-center">{{ __('root.reports.profit_or_loss_account_manage') }}</h2>
            <br>
        </div>
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <form class="form" id="form_validation" method="post"
                                    action="{{ route('reports.accounts.profit_or_loss_account.report') }}">
                                    {{ csrf_field() }}
