 ...
 <div class="content">
  ...
  <div class="mid mb-3">
        <div class="row">
            ...
            <h4 class="text-center mb-3">{{ $search_by['type_name'] }} - {{ $search_by['branch_name'] }}</h4>
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 mb-5">
                        <table class="table table-bordered table-sm table-hover">
                            <thead>
                                ...
                                <tr>
                                    <th class="text-left" scope="col"style="background-color: #214597 !important; #fff: white !important;">Ledger Name</th>
