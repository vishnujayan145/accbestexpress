                                ...
                                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                                    ...
                                    <table class="table table-bordered table-sm table-hover">
                                        ...
                                        <tr style="background-color:#cfd3d7 !important;color:#fff;text-align:center;color:red">
                                            <th colspan="8" style="text-align:center;color:red">Opening Balance</th>
                                            @php
                                        ...
                                        <tbody>
                                            ...
                                            // Determine the parent route name based on voucher type
                                            $ParentRouteName = $transaction->voucher_type === 'CV' ? 'cr_voucher' :
                                            ($transaction->voucher_type === 'JV' ? 'jnl_voucher' :
                                            ($transaction->voucher_type === 'Contra' ? 'contra_voucher' : 'dr_voucher'));
                                            @endphp
