                ...
                <table class="table table-bordered table-sm table-hover">
                    ...
                    <tbody>
                        ...
                        <tr  style="background-color:#6c757d;color:#fff">
                            <td class="font-w-b text-right font-s-20" style="background-color:#6c757d !important;color:#fff">
                        ...
                        <tr  style="background-color:#6c757d;color:#fff">
                            <td class="font-w-b text-right fon-s-20"style="background-color:#6c757d !important;color:#fff">
