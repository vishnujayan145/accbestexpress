...
@section('title')
    {{ __('root.reports.statement_of_financial_position') }}
@stop
@section('top-bar')
...
@section('content')
    <section @if($is_rtl) dir="rtl" @endif class="content">
        <div class="header">
            <h2 class="text-center">{{ __('root.reports.statement_of_financial_position') }}</h2>
            <br>
        </div>
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <form class="form" id="form_validation" method="post"
                                    action="{{ route('reports.accounts.balance_sheet.report') }}">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select data-live-search="true" class="form-control show-tick"
                                                    name="branch_id">
                                                    <option value="0">{{ __('root.reports.select_branch_name') }}</option>
