                    ...
                    <table class="table table-bordered table-sm table-hover">
                        <thead>
                            ...
                            <tr id="trtop">
                                ...
                                <th class="text-center font-s-18"style="background-color: #214597 !important; #fff: white !important;">
                                    Head Of Account
                                </th>
                                <th class="text-center font-s-18" colspan="2"style="background-color: #214597 !important; #fff: white !important;">
                        ...
                        <tbody>
                            ...
                            @if (count($items['branches']) == $branch_number)
                                <tr style="background-color:#6c757d;color:#fff">
                                    <th class="text-right font-s-20" colspan="2" style="background-color:#6c757d !important;color:#fff">Total Amount=</th>
                                    <th class="text-right font-s-20" style="background-color:#6c757d !important;color:#fff">{{ Helper::convertMoneyFormat($total_dr) }}
                                    </th>
                                    <th class="text-right font-s-20" style="background-color:#6c757d !important;color:#fff">{{ Helper::convertMoneyFormat($total_cr) }}
                                    </th>
                                </tr>
                            @endif
                        </tbody>
            ...
            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                <table class="table table-bordered table-sm table-hover">
                    <thead>
                        ...
                        <tr id="trtop" style="background-color:#cfd3d7 !important;color:#fff;text-align:center;color:red">
                            <th class="text-center" scope="col"style="background-color:#cfd3d7 !important;text-align:center;color:red"></th>
                            <th scope="col"style="background-color:#cfd3d7 !important;text-align:center;color:red"></th>
                            <th class="text-right" scope="col"style="background-color:#cfd3d7 !important;text-align:center;color:red">Dr ( <?php echo config('settings.is_code') == 'code' ? config('settings.currency_code') : config('settings.currency_symbol'); ?> )
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr style="background-color:#6c757d !important;color:#fff">
                            <th class="text-right font-s-20" colspan="2" style="background-color:#6c757d !important;color:#fff">Grand Total Amount =</th>
                            <th class="text-right font-s-20" style="background-color:#6c757d !important;color:#fff">{{ Helper::convertMoneyFormat($total_cr) }}</th>
                            <th class="text-right font-s-20" style="background-color:#6c757d !important;color:#fff">
