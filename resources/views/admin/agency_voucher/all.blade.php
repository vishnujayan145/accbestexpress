        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb breadcrumb-col-cyan @if ($is_rtl) pull-left  @else pull-right @endif">
                ...
                <li><a href="{{ route('agency_voucher.all') }}"><i
                            class="material-icons">{{ $breadcrumbMainIcon }}</i>&nbsp;{{ 'Agency Voucher Manage' }}</a></li>
                <li class="active"><i
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{'Total Amount' }} ( <?php echo config('settings.is_code') == 'code' ? config('settings.currency_code') : config('settings.currency_symbol'); ?>
                                                    )
                                                </th>
