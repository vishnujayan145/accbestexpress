                        ...
                        <div class="body">
                            <table class="table  table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th  style="background-color: #214597 !important; color: #fff;">C.Q No</th>

                                    <th  style="background-color: #214597 !important; color: #fff;">Dr ( <?php echo (config('settings.is_code') == 'code') ?
                                            config('settings.currency_code') : config('settings.currency_symbol')  ?>
                                        )
                                    </th>
                                    <th  style="background-color: #214597 !important; color: #fff;">Cr ( <?php echo (config('settings.is_code') == 'code') ?
                                            config('settings.currency_code') : config('settings.currency_symbol')  ?>
                                        )
                                    </th>
                                ...
                                <tr>
                                    <th colspan="2" class="text-right" style="background-color: #bdb8b8 !important; color: #ec2026 !important ;">Total=</th>
