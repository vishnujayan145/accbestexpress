                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <a @if ($trash_show == 0) class="dis-none" @endif
                                ...
                                href="{{ route($ParentRouteName) }}">{{ __('root.common.trash') }}({{ $count_trashed_cnt }}
                                )</a>
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{ __('root.contra_voucher.ref_no') }}</th>
                                                <th>{{ __('root.contra_voucher.made_of_payment') }}</th>
                                                <th>{{ __('root.contra_voucher.amount') }}-Cr ( <?php echo config('settings.is_code') == 'code' ? config('settings.currency_code') : config('settings.currency_symbol'); ?>
                                                )
                                                </th>
                                                <th>{{ __('root.contra_voucher.amount') }} -Dr( <?php echo config('settings.is_code') == 'code' ? config('settings.currency_code') : config('settings.currency_symbol'); ?>
                                                    )
                                                </th>
