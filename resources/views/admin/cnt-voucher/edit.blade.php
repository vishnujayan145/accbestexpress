                                ...
                                <form class="form" id="form_validation" method="post"
                                    ...
                                    <div class="row clearfix">
                                                ...
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        @foreach ($branches->sortByDesc('id') as $project)
                                                            <option
                                                                @if ($project->id == $items[0]->branch_id) )
                                                                        selected @endif
                                                ...
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        @foreach ($bank_cashes->sortByDesc('id') as $bank_cash)
                                                            <option @if ($bank_cash->id == $items[0]->bank_cash_id) selected @endif
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input
                                                        value="{{ $items[0]->bank_cash_id > 1 ? $items[0]->cheque_number : $items[1]->cheque_number }}"
                                                        name="cheque_number" type="text" class="form-control">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        @foreach ($bank_cashes->sortByDesc('id') as $bank_cash)
                                                            <option @if ($bank_cash->id == $items[1]->bank_cash_id) selected @endif
                                                                value="{{ $bank_cash->id }}">{{ $bank_cash->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line" id="bs_datepicker_container">
                                                    <input autocomplete="off"
                                                        value="{{ date('m/d/Y', strtotime($items[0]->voucher_date)) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <textarea name="particulars" rows="2" class="form-control no-resize" placeholder="Particulars">{{ $items[0]->particulars }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
