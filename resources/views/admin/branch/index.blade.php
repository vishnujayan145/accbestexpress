                    ...
                    <div class="card">
                        <div class="header">
                            <a class="btn btn-xs btn-info waves-effect"
                                href="{{ route($ParentRouteName) }}">{{ __('root.common.all') }}({{ $total_branches }})</a>
                            <a @if ($trash_show == 0) class="dis-none" @endif
                                class="btn btn-xs btn-danger waves-effect text-black"
                                href="{{ route($ParentRouteName . '.trashed') }}">{{ __('root.common.trash') }}({{ $total_trashed_branches }}
                                )</a>
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{ __('root.branch.name') }}</th>
                                                <th>{{ __('root.branch.location') }}</th>
                                                <th>{{ __('root.branch.options') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $i = 1; ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tdTrashAction">
                                                        <a @if ($edit == 0) class="dis-none" @endif
                                                            ...
                                                            data-toggle="tooltip" data-placement="top" title="{{ __('root.common.edit') }}"><i
                                                        ...
                                                        <a @if ($delete == 0) class="dis-none" @endif
                                                            ...
                                                            data-toggle="tooltip" data-placement="top" title="{{ __('root.common.trash') }}"> <i
                                ...
                                @else
                                    <div class="body table-responsive">
                                        <table class="table table-hover table-bordered">
                                            <thead>
                                                <tr>
                                                    <th class="text-danger text-center">{{ __('root.common.no_data_found') }}</th>
                                                </tr>
                                            </thead>
                                        </table>
                                    </div>
