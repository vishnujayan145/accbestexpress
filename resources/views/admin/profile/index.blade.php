                            ...
                            <div>
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#profile_settings"
                                            aria-controls="settings" role="tab" data-toggle="tab">Profile Settings</a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active" id="profile_settings">
                                        <form enctype="multipart/form-data" class="form-horizontal" method="post"
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-line">
                                                        <select class="form-control show-tick" name="gender"
                                                            ...
                                                            <option @if ($profile['gender'] == 1) selected @endif
                                                                value="1">Male
                                                            </option>
                                                            <option @if ($profile['gender'] == 2) selected @endif
                                                                value="2">Female
                                                            </option>
                                                            <option @if ($profile['gender'] == 3) selected @endif
                                                                value="3">Common
                                                            </option>
                                                            <option @if ($profile['gender'] == 4) selected @endif
                                                                value="4">Not Willing To Say
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-line">
                                                        ...
                                                        <textarea class="form-control" id="description" name="description" rows="1" placeholder="description">{{ $profile['description'] }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="description" class="col-sm-2 control-label">Profile
                                                    Picture</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group">
                                                <label for="language_id" class="col-sm-2 control-label">Add Language</label>
                                                <div class="col-sm-10">
                                                    <div class="form-line">
                                                        <select class="form-control show-tick" name="language_id"
                                                            ...
                                                            @foreach ($languages as $language)
                                                                <option @if ($language_id == $language->id)
                                                                    selected
