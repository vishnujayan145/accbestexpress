    ...
    <section @if($is_rtl) dir="rtl" @endif class="content">
        <div class="container-fluid">
            <div class="block-header @if ($is_rtl) pull-right @else pull-left @endif">
                <a class="btn btn-sm btn-info waves-effect" href="javascript:history.back()">{{ __('root.common.back') }}</a>
            </div>
                                ...
                                <form class="form" id="form_validation" method="post"
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        @foreach ($branches->sortByDesc('id') as $branch)
                                                            <option @if ($branch->id == $items['dr'][0]->branch_id) selected @endif
                                    ...
                                    <div class="row dr">
                                                    ...
                                                    <select data-live-search="true"
                                                        ...
                                                        @foreach ($income_expense_heads->sortByDesc('id') as $HeadOfAccount)
                                                            ...
                                                            @else
                                                                @php($id = 0)
                                                            @endif
                                                            <option @if ($HeadOfAccount->id == $id) selected @endif
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input
                                                        value="{{ !empty($items['dr'][0]->dr) ? $items['dr'][0]->dr : 0 }}"
                                                        name="amount[]" type="number" class="form-control amount"  step="any">
                                    ...
                                    <div class="row dr">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input
                                                        value="{{ !empty($items['dr'][1]->dr) ? $items['dr'][1]->dr : 0 }}"
                                                        name="amount[]" type="number" class="form-control amount"  step="any">
                                                    <label class="form-label">Amount ( Dr ) </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row dr">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input
                                                        value="{{ !empty($items['dr'][2]->dr) ? $items['dr'][2]->dr : 0 }}"
                                                        name="amount[]" type="number" class="form-control amount"  step="any">
                                                    <label class="form-label">Amount ( Dr )</label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row dr">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input
                                                        value="{{ !empty($items['dr'][3]->dr) ? $items['dr'][3]->dr : 0 }}"
                                                        name="amount[]" type="number" class="form-control amount"  step="any">
                                                    <label class="form-label">Amount ( Dr )</label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row dr">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input
                                                        value="{{ !empty($items['dr'][4]->dr) ? $items['dr'][4]->dr : 0 }}"
                                                        name="amount[]" type="number" class="form-control amount"  step="any">
                                                    <label class="form-label">Amount ( Dr )</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        @foreach ($branches->sortByDesc('id') as $branch)
                                                            <option @if ($branch->id == $items['cr'][0]->branch_id) selected @endif
                                                                value="{{ $branch->id }}">{{ $branch->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select data-live-search="true"
                                                        ...
                                                        name="income_expense_head_id_cr[]" id="">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ $items['cr'][0]->cr }}" name="amount_cr[]"
                                                        type="number" class="form-control amount_cr"  step="any">
                                    ...
                                    <div class="row cr">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input
                                                        value="{{ !empty($items['cr'][1]->cr) ? $items['cr'][1]->cr : 0 }}"
                                                        name="amount_cr[]" type="number" class="form-control amount_cr" step="any">
                                                    <label class="form-label">Amount ( Cr ) </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row cr">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input
                                                        value="{{ !empty($items['cr'][2]->cr) ? $items['cr'][2]->cr : 0 }}"
                                                        name="amount_cr[]" type="number" class="form-control amount_cr" step="any">
                                                    <label class="form-label">Amount ( Cr )</label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row cr">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input
                                                        value="{{ !empty($items['cr'][3]->cr) ? $items['cr'][3]->cr : 0 }}"
                                                        name="amount_cr[]" type="number" class="form-control amount_cr"  step="any">
                                                    <label class="form-label">Amount ( Cr )</label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row cr">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input
                                                        value="{{ !empty($items['cr'][4]->cr) ? $items['cr'][4]->cr : 0 }}"
                                                        name="amount_cr[]" type="number" class="form-control amount_cr" step="any">
                                                    <label class="form-label">Amount ( Cr )</label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <textarea name="particulars" rows="2" class="form-control no-resize" placeholder="Particulars">{{ $items['dr'][0]->particulars }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                getValues: function() {
                    ...
                    return {
                        project_id: Fields.get_project_id.value == "" ? 0 : parseFloat(Fields.get_project_id
                            .value),
                        project_id_cr: Fields.get_project_id_cr.value == "" ? 0 : parseFloat(Fields
                            .get_project_id_cr.value),
        ...
        var MainController = (function(UICnt) {
            ...
            var validation = function(e) {
                ...
                var get_head_of_account_id_five = Fields.get_head_of_account_id[8].querySelector('select')
                    .value == "" ? 0 : parseFloat(Fields.get_head_of_account_id[8].querySelector('select')
                        .value);
                var get_head_of_account_id_cr_one = Fields.get_head_of_account_id_cr[0].querySelector('select')
                    .value == "" ? 0 : parseFloat(Fields.get_head_of_account_id_cr[0].querySelector('select')
                        .value);
                var get_head_of_account_id_cr_two = Fields.get_head_of_account_id_cr[2].querySelector('select')
                    .value == "" ? 0 : parseFloat(Fields.get_head_of_account_id_cr[2].querySelector('select')
                        .value);
                var get_head_of_account_id_cr_three = Fields.get_head_of_account_id_cr[4].querySelector(
                    'select').value == "" ? 0 : parseFloat(Fields.get_head_of_account_id_cr[4]
                    .querySelector('select').value);
                var get_head_of_account_id_cr_four = Fields.get_head_of_account_id_cr[6].querySelector('select')
                    .value == "" ? 0 : parseFloat(Fields.get_head_of_account_id_cr[6].querySelector('select')
                        .value);
                var get_head_of_account_id_cr_five = Fields.get_head_of_account_id_cr[8].querySelector('select')
                    .value == "" ? 0 : parseFloat(Fields.get_head_of_account_id_cr[8].querySelector('select')
                        .value);
                ...
                if (TotalDrAmount === TotalCrAmount) {} else {
