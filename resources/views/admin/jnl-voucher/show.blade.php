                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <table class="table  table-bordered table-hover">
                                <thead>
                                <tr id="trtop">
                                    <td>Branch Name: {{ App\Transaction::find($items[0]->id)->Branch->name }} 
                                    </td>
                                    <td>Branch Name: {{ App\Transaction::find($items[1]->id)->Branch->name }}
                                    </td>
                        ...
                        <div class="body">
                            <table class="table  table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th  style="background-color: #214597 !important; color: #fff;">Made Of Payment</th>

                                    <th scope="col"  style="background-color: #214597 !important; color: #fff;">Debit ( <?php echo (config('settings.is_code') == 'code') ?
                                            config('settings.currency_code') : config('settings.currency_symbol')  ?>
                                        )
                                    </th>
                                    <th scope="col"  style="background-color: #214597 !important; color: #fff;">Credit ( <?php echo (config('settings.is_code') == 'code') ?
                                            config('settings.currency_code') : config('settings.currency_symbol')  ?>
                                        )
                                ...
                                @endforeach
                                <tr>
                                    <th colspan="1" class="text-right" style="background-color: #bdb8b8 !important; color: #ec2026 !important ;">Total=</th>
                                    <th style="background-color: #bdb8b8 !important; color: #ec2026 !important ;">{{ $transaction->convert_money_format($dr_total_amount)  }}-/</th>
                                    <th style="background-color: #bdb8b8 !important; color: #ec2026 !important ;">{{ $transaction->convert_money_format($cr_total_amount)  }}-/</th>
