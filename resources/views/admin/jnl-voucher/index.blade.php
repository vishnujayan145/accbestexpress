                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <a @if ($trash_show == 0) class="dis-none" @endif
                                ...
                                href="{{ route($ParentRouteName) }}">{{ __('root.common.trash') }}({{ $count_trashed_jv }}
                                )</a>
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">{{ __('root.jnl_voucher.voucher_no') }}</th>
                                                <th>{{ __('root.jnl_voucher.particulars') }}</th>
                                                <th>{{ __('root.jnl_voucher.branch_name') }}</th>
                                                <th>{{ __('root.jnl_voucher.date') }}</th>
                                                <th>{{ __('root.jnl_voucher.head_of_account_name') }}</th>
                                                <th>{{ __('root.jnl_voucher.made_of_payment') }}</th>
                                                <th>{{ __('root.jnl_voucher.chq_no') }}</th>
                                                <th>{{ __('root.jnl_voucher.amount') }} ( <?php echo config('settings.is_code') == 'code' ? config('settings.currency_code') : config('settings.currency_symbol'); ?>
                                                    )
                                                </th>
                                                <th>{{ __('root.jnl_voucher.ref_no') }}</th>

                                                <th>{{ __('root.jnl_voucher.options') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $i = 1; ?>
                                            @foreach ($items as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->income_expense_head_id }}</td>
