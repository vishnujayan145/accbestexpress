...
<section @if($is_rtl) dir="rtl" @endif class="content">
                            ...
                            <form class="form" id="form_validation" method="post"
                                ...
                                <div class="row dr">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input name="amount[]" type="number" class="form-control amount" step="any">
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select data-live-search="true" class="form-control show-tick"
                                                    ...
                                                    @foreach ($branches->sortByDesc('id') as $branch)
                                                    <option @if ($branch->id == old('branch_id_cr')) selected @endif
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input name="amount_cr[]" type="number"
                                                    class="form-control amount_cr" step="any">
                                ...
                                <div class="row cr">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input name="amount_cr[]" type="number" step="any"
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 field_area">
        <div class="form-group form-float">
            <div class="form-line">
                <textarea name="particulars" rows="2" 
