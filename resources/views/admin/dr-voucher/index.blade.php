                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <a @if ($trash_show == 0) class="dis-none" @endif
                                ...
                                href="{{ route($ParentRouteName) }}">{{ __('root.common.trash') }}({{ $count_trashed_dv }}
                                )</a>
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{ __('root.dr_voucher.amount') }} ( <?php echo config('settings.is_code') == 'code' ? config('settings.currency_code') : config('settings.currency_symbol'); ?>
                                                    )
                                                </th>
