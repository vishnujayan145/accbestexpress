                        ...
                        <div class="body">
                            <table class="table  table-bordered table-hover">
                                ...
                                @foreach($items as $key=>$item)
                                    ...
                                    <tr>
                                        <td class="text-center" style="color:#000 !important;">{{ $key+1  }}</td>
                                        <td style="color:#000 !important;">{{ App\Transaction::find($item->id)->IncomeExpenseHead->name }}</td>
                                        <td style="color:#000 !important;">{{ $item->cheque_number }}</td>
                                        <th style="color:#000 !important;"> {{ $transaction->convert_money_format($amount)  }}</th>
