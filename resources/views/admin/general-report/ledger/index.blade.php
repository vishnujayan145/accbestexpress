    ...
    <section @if($is_rtl) dir="rtl" @endif class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <form class="form" id="form_validation" method="post"
                                      action="{{ route('reports.general.ledger.type.report')  }}">
                ...
                <!-- Ledger Type Wise End -->


                <!-- Ledger Group Wise Start -->
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="card">
                        <div class="header bg-cyan">
                            <h2>
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <form class="form" id="form_validation" method="post"
                                      action="{{ route('reports.general.ledger.group.report')  }}">
                ...
                <!-- Ledger Group Wise End -->

                <!-- Ledger Name Wise Start -->
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="card">
                        <div class="header bg-cyan">
                            <h2>
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <form class="form" id="form_validation" method="post"
                                      action="{{ route('reports.general.ledger.name.report')  }}">
