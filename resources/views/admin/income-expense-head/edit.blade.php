                                    ...
                                    <div class="row clearfix">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control  show-tick"
                                                        name="income_expense_type_id" id="">
                                                        <option value="0">Select Income/Expense Head Type</option>
                                                        @foreach ($income_expense_types as $income_expense_type_id)
                                                            <option @if ($income_expense_type_id->id == $item->income_expense_type_id) selected @endif
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control  show-tick"
                                                        ...
                                                        @foreach ($income_expense_groups as $IncomeExpenseGroups)
                                                            <option @if ($IncomeExpenseGroups->id == $item->income_expense_group_id) selected @endif
                                                                value="{{ $IncomeExpenseGroups->id }}">
                                                                {{ $IncomeExpenseGroups->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                           ...
                                           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ $item->opening_balance }}" name="opening_balance" type="text"
                                                        class="form-control">
