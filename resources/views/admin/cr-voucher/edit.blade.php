                                ...
                                <form class="form" id="form_validation" method="post"
                                                ...
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        @foreach ($bank_cashes->sortByDesc('id') as $bank_cash)
                                                            <option
                                                                @if ($bank_cash->id == $item[0]->bank_cash_id) )
                                                                        selected @endif
                                    ...
                                    <div class="row dr">
                                                ...
                                                <div class="form-line">
                                                    <select data-live-search="true"
                                                        ...
                                                        @foreach ($income_expense_heads->sortByDesc('id') as $HeadOfAccount)
                                                            <option @if ($HeadOfAccount->id == $item[0]->income_expense_head_id) selected @endif
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ $item[0]->amount }}" name="amount[]" type="number" step="any"
                                                ...
                                                <div class="form-line">
                                                    <select data-live-search="true"
                                                        ...
                                                        @foreach ($income_expense_heads as $HeadOfAccount)
                                                            <option @if ($HeadOfAccount->id == $headOfAccountID1) selected @endif
                                                                value="{{ $HeadOfAccount->id }}">
                                                                {{ $HeadOfAccount->name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select data-live-search="true"
                                                        ...
                                                        <option value="0"> Select Head of Account Name</option>
                                                        @foreach ($income_expense_heads as $HeadOfAccount)
                                                            <option @if ($HeadOfAccount->id == $headOfAccountID2) selected @endif
                                                                value="{{ $HeadOfAccount->id }}">
                                                                {{ $HeadOfAccount->name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select data-live-search="true"
                                                        ...
                                                        <option value="0"> Select Head of Account Name</option>
                                                        @foreach ($income_expense_heads as $HeadOfAccount)
                                                            <option @if ($HeadOfAccount->id == $headOfAccountID3) selected @endif
                                                                value="{{ $HeadOfAccount->id }}">
                                                                {{ $HeadOfAccount->name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select data-live-search="true"
                                                        ...
                                                        <option value="0"> Select Head of Account Name</option>
                                                        @foreach ($income_expense_heads as $HeadOfAccount)
                                                            <option @if ($HeadOfAccount->id == $headOfAccountID4) selected @endif
                                                                value="{{ $HeadOfAccount->id }}">
                                                                {{ $HeadOfAccount->name }}</option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line" id="bs_datepicker_container">
                                                    <input autocomplete="off"
                                                        value="{{ date('m/d/Y', strtotime($item[0]->voucher_date)) }}"
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <textarea name="particulars" rows="2" class="form-control no-resize" placeholder="Particulars">{{ $item[0]->particulars }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
