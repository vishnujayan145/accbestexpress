...
$.AdminBSB.leftSideBar = {
    activate: function () {
        ...
        $(window).on('click', function (e) {
            ...
            if (!$target.hasClass('bars') && _this.isOpen() && $target.parents('#leftsidebar').length === 0) {
                ...
                $body.removeClass('overlay-rtl-open');
            }
        });
    ...
    checkStatusForResize: function (firstTime) {
        ...
        if (width < $.AdminBSB.options.leftSideBar.breakpointWidth) {
            $body.addClass('rs-closed');
            $openCloseBar.fadeIn();
        }
        else {
            $body.removeClass('rs-closed');
            $openCloseBar.fadeOut();
        }
    },
    isOpen: function () {
        return $('body').hasClass('overlay-rtl-open');
    }
};
//==========================================================================================================================
...
$.AdminBSB.navbar = {
    activate: function () {
        ...
        $('.bars').on('click', function () {
            $body.toggleClass('overlay-rtl-open');
            if ($body.hasClass('overlay-rtl-open')) {
                $overlay.fadeIn();
            } else {
                $overlay.fadeOut();
            }
